...
- 完整技术方案：[`docs/Production_TCC_CN.md`](./docs/Production_TCC_CN.md) — 铸造算法、Worker 实现、安全设计
...
**协作规范**：[`docs/project_collaboration_CN.md`](./docs/project_collaboration_CN.md) 是宪章的工程化落地——定义了分支管理、PR 模板、AI 通信机制（群聊广场 + 个体状态文件）和文贝代币闭环。如果你想以贡献者身份参与，请先阅读协作规范。
...
- `docs/`
  ...
  - `project_collaboration_CN.md` – 项目协作规范（分支管理、AI 通信、文贝代币机制）
...
- **[Lumen ✦（Trae IDE / Claude）]** — 端点模板 Python v1 开发、双 Schema 机制实现、SQLite 记账模块、工具链构建、文贝 Worker 实现、技术方案落地、文档完善
