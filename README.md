...
只需让 Agent 匹配用户的意图，按模板拼接指令并 POST，极低成本即可扩展无限能力。具体集成方法请参阅 **[集成到Agent.md](./docs/集成到Agent.md)**。
...
- `docs/`
  - `文本服务构建指南.md` – 供开发者快速自建指令服务（Node.js & Python 双版）
  - `集成到Agent.md` – 指导 Agent 如何动态接入 text-cli 生态
