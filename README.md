...
`text-cli` 为所有非开发者提供了一条清晰的路径。请参阅我们的详细指南：**[Markdown2Text-cli.md](./docs/Markdown2Text-cli.md)**
...
- `docs/`
  ...
  - `Markdown2Text-cli.md` – 供非开发者将自己的经验转化为指令
...
**Q: 我不是开发者，怎么把技能变成指令？**  
请参阅我们的 **[非开发者指南](./docs/Markdown2Text-cli.md)**，仅需上传一份经验文档，Agent 即可代运营。
